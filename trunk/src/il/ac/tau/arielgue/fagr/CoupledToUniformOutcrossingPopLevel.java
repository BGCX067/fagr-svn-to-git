 ...
 * (when pop is large)
 */
public class CoupledToUniformOutcrossingPopLevel implements OutcrossingStrategy {
	...
	private int effectiveOutcrossings = Integer.MIN_VALUE;;

	public CoupledToUniformOutcrossingPopLevel() {
